                                                        ...
                                                        if(token){
                                                            ...
                                                            Account.findById(decode.id)
                                                                .then(function(account){
                                                                    ...
                                                                    //     refF: refF
                                                                    // })
                                                                    res.json({tours, types, total, totalPage, services, refF, account, destinations})
                                                                })
                                                                .catch(function(err){
                                                                    console.log(err)
                                                                })
                                                            ...
                                                            //     refF: refF
                                                            // })
                                                            res.json({tours, types, total, totalPage, services, refF, destinations})
                                                        }
                                                    })
                                                    .catch(function(err){
                                                        console.log(err)
                                        ...
                                        if(token){
                                            ...
                                            Account.findById(decode.id)
                                                .then(function(account){
                                                    ...
                                                    // })
                                                    res.json({tour, destinations, account, tourSimilar})
                                            ...
                                            //     destinations: destinations,
                                            // })
                                            res.json({tour, destinations, tourSimilar})
                                        }
                                    })
                                    .catch(function(err){
                                        console.log(err)
                            ...
                            if(token){
                                ...
                                Account.findById(decode.id)
                                    .then(function(account){
                                        ...
                                        //     destinations: destinations
                                        // })
                                        res.json({tours, destinations, account})
                                    })
                                    .catch(function(err){
                                        console.log(err)
                                    })
